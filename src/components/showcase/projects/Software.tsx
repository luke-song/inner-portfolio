    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    lukesong.xyz is my portfolio website, and also the website
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://portfolio-inner-site-ashen.vercel.app/"
                    >
                        here
                    </a>{' '}
                ...
                <ul>
                    ...
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - lukesong.vercel.app
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/luke-song/portfolio-website"
                        >
                            <p>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/luke-song/portfolio-inner-site"
                        >
                            <p>
